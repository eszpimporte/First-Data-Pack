...
function hygrave:internal/config/change/requirements/grave_looting_requirements/owners/item_ids/remove_item_index_macro with storage hygrave:common temp.args
