...
function hygrave:internal/config/change/requirements/grave_generation_requirements/with_item/item_ids/remove_item_index_macro with storage hygrave:common temp.args
