...
function hygrave:internal/config/change/graves/item_distribution/grave_generation_success/remove/item_ids/remove_item_index_macro with storage hygrave:common temp.args
