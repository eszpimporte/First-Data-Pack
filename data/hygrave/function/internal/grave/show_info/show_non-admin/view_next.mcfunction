...
execute store result storage hygrave:common temp.gid int 1 run scoreboard players get @s hygrave.show_grave_info.view_next
...
execute store result score .return_value hygrave.temp_var run function hygrave:internal/grave/show_info/show_non-admin/view_next/loop with storage hygrave:common temp.args1
