#@> Executed from:
#@>   function hygrave:internal/grave/show_info/show_admin/view_previous
#@>   function hygrave:internal/grave/show_info/show_admin/view_previous/loop
...
return run function hygrave:internal/grave/show_info/show_admin/view_previous/loop with storage hygrave:common temp.args1
