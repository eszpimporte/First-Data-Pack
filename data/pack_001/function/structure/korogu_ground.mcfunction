...
execute if score #tempo data_difficulty matches 1 run place template pack_001:petites_structures/korogu_fly ~ ~20 ~ none none
execute if score #tempo data_difficulty matches 2 run place template pack_001:petites_structures/korogu_ground ~ ~ ~ none none
execute if score #tempo data_difficulty matches 3 run place template pack_001:petites_structures/korogu_undertale ~ ~-40 ~ none none
